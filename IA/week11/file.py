...
matches = pd.read_csv("C:\Coding\IA\week11\main17-23.csv")
...
predictors = ["venue_code", "opp_code", "hour", "day_code", "season",
              "referee_code", "captain", "formation", "kp", "sca", "xg", "xga"]
...
cols = ["gf", "ga", "sh", "sot", "dist", "fk", "pk", "pkatt", "kp",
        "third", "ppa", "crspa", "att_3rd", "att_pen", "prog", "sca", "tb"]
...
combined.to_csv("C:\Coding\IA\week11\FormattedDF2.csv")
